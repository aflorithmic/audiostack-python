...
def test_create_from_production_and_image():
    ...
    print(video)
    assert video.status == 200, "Video from production and image Failed"
...
def test_create_from_production_and_video():
    ...
    print(video)
    assert video.status == 200, "Video from production and video Failed"
...
def test_create_from_file_and_image():
    ...
    video =Video.create_from_file_and_image(
        fileId=fileId,
        mode=mode,
        format=format
    )
